    ...
    <main class="flex flex-col w-full space-y-10">
        ...
        <div class="flex justify-center space-x-28">
            ...
            <div class="review">
                ...
                <p>Emily from xyz</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, est aut architecto dolore quibusdam
                    quia tenetur mollitia doloremque esse ipsa, blanditiis eaque expedita optio labore sit aspernatur
                    nostrum. Rem, fugit.</p>
            </div>
            <div class="review">
                <img src="assets/resources/image-thomas.jpg" class="rounded-full w-32" alt="">
                <p>Thomas from corporate</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aliquam, libero assumenda inventore id,
                    officia maiores voluptate sint similique consequatur ducimus enim veritatis harum asperiores
                    numquam? Mollitia iure voluptate doloribus ullam!</p>
            </div>
            <div class="review">
                <img src="assets/resources/image-jennie.jpg" class="rounded-full w-32" alt="">
                <p>Jennie from Nike</p>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Velit eos quam distinctio sequi itaque
                    dolore aspernatur quia eaque, facilis, voluptatem amet pariatur incidunt veniam nostrum quibusdam
                    reiciendis molestiae dolorem! Et!</p>
            </div>
        </div>
    </main>
    <footer>
