...
<body class="min-h-screen flex flex-col items-center text-white bg-gradient-to-t from-slate-900 to-slate-500">
    ...
    <main class="flex flex-col w-full space-y-10">
        <div class="flex items-center justify-evenly space-x-20"> <!--BIG TITLE + SHOE -->
            <div>
                ...
                <button class=" text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 mt-4">See our store</button>
            </div>
            <div class="relative">
        ...
        <div class="flex flex-col items-center"><!--PROVIDE THE BEST QUALITY-->
            <img src="assets/resources/shoe_two.png" alt="shoe" width="450px">
            <p class="text-8xl text-center">WE PROVIDE YOU<br>THE <span class="text-blue-700">BEST</span> QUALITY.</p>
            <p class="text-2xl text-center w-3/5 mt-6">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas veritatis, quam quae dolores reiciendis velit nobis eum quo pariatur id recusandae nostrum at rem vel, quia facere iste architecto nemo!</p>
        </div>
        <div class="flex flex-row justify-center space-x-28 w-[80%] m-auto"><!--REVIEWS-->
            <div class="review">
                <img src="assets/resources/image-emily.jpg" class="rounded-full w-32" alt="emily">
            ...
            <div class="review">
                <img src="assets/resources/image-thomas.jpg" class="rounded-full w-32" alt="thomas">
            ...
            <div class="review">
                <img src="assets/resources/image-jennie.jpg" class="rounded-full w-32" alt="jennie">
    ...
    <footer class="flex border-t-[1px] border-slate-400 border-solid h-20 w-full text-center justify-center items-center text-sm m-auto mt-6">
